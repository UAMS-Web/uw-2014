...
class UAMS_Widget_Related_Posts extends WP_Widget
{
  ...
  const ID    = 'uams-widget-related-posts';
  const TITLE = 'UAMS Related Posts';
  ...
  function UAMS_Widget_Related_Posts()
  {
...
class UAMS_Related_Posts
{
  ...
  function register()
  {
    if ( $this->jetpackInstalled() )
      register_widget( 'UAMS_Widget_Related_Posts' );
  }
